        ...
        {activeTab === 'list' ? (
          ...
          <View style={styles.listContainer}>
            <View style={styles.listHeader}>
              ...
              <Text style={styles.listCount}>{filteredUsers.length} usuarios</Text>
            </View>
            ...
            <View style={styles.listControls}>
              ...
              <View style={styles.pageSizeRow}>
                ...
                <Text style={styles.pageSizeSuffix}>/pág</Text>
              </View>
            </View>
            ...
            {loading ? (
              ...
              <View style={styles.pagination}>
                <TouchableOpacity
                  ...
                  disabled={safePage <= 1}
                >
                  <MaterialIcons name="first-page" size={22} color="#475569" />
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.pageButton, safePage <= 1 && styles.pageButtonDisabled]}
                ...
                <View style={styles.pageInfoBlock}>
                  ...
                  <Text style={styles.rangeInfo}>
                    ...
                    -{Math.min(startIndex + pageSize, filteredUsers.length)} de {filteredUsers.length}
                  </Text>
                </View>
                <TouchableOpacity
                ...
                <TouchableOpacity
                  ...
                  disabled={safePage >= totalPages}
                >
                  <MaterialIcons name="last-page" size={22} color="#475569" />
                </TouchableOpacity>
              </View>
              </>
            )}
